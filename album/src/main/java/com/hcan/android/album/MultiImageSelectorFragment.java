...
import com.hcan.android.album.adapter.FolderAdapter;
import com.hcan.android.album.adapter.ImageGridAdapter;
import com.hcan.android.album.bean.Folder;
import com.hcan.android.album.bean.Image;
import com.hcan.android.album.utils.FileUtils;
import com.hcan.android.album.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mode == MODE_MULTI && getArguments() != null) {
        ...
        mCategoryText.setOnClickListener(view1 -> {
            ...
            } else if (mFolderPopupWindow.getListView() != null) {
