...
public class JmRadiusImageView extends AppCompatImageView {
    ...
    public JmRadiusImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public JmRadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.JmRadiusImageView);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.JmRadiusImageView_jm_border_width, 0);
        mBorderColor = array.getColor(R.styleable.JmRadiusImageView_jm_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.JmRadiusImageView_jm_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.JmRadiusImageView_jm_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.JmRadiusImageView_jm_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.JmRadiusImageView_jm_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.JmRadiusImageView_jm_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.JmRadiusImageView_jm_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(R.styleable.JmRadiusImageView_jm_corner_radius, 0);
        }
        array.recycle();
    }
