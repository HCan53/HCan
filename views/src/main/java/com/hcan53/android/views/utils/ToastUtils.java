package com.hcan53.android.views.utils;
...
import com.hcan53.android.views.ViewsInit;
...
public class ToastUtils {
    ...
    public static void reset() {
        ...
        setMsgTextSize(14);
        setBgResource(-1);
        setGravity(Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, ViewsInit.getApp().getResources()
                .getDimensionPixelSize(R.dimen.offset_64));
    }

    private static void show(@StringRes final int resId, final int duration) {
        show(ViewsInit.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(ViewsInit.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(ViewsInit.getApp(), null, duration);
                sToast.setText(text);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(ViewsInit.getApp());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) ViewsInit.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
